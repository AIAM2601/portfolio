      ...
      <main className="bg-white dark:bg-[#0c4a6e]">
        ...
        <div className="text-center">
          <div className="mx-auto mt-3 lg:w-80 lg:h-80 md:w-80 md:h-80 sm:w-80 sm:h-80 min-[300px]:w-60 min-[300px]:h-60">
            <Image src={kratos} className="rounded-full" alt="kratos" />
          </div>
        ...
        <div className=" flex items-center justify-center mt-1 text-[20px] ">
          <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-0">
            <div className="dark:text-white max-w-sm rounded overflow-hidden shadow-lg px-6 py-4">
        ...
        <div id="contact" className="text-center py-1 pb-10">
          ...
          <div id="IconsLinks" className="">
            <a href="mailto:andres.aguilarfl@gmail.com" target="_blank">
              <i className="fa-regular p-6 fa-envelope mt-3 fa-3x dark:[color:white] hover:[color:#0c4a6e] dark:hover:[color:#02141f]"></i>
            </a>
            <a
              href="https://www.linkedin.com/in/andres-aguilar-569319161/"
              target="_blank"
            >
              <i className="fa-brands p-6 fa-linkedin  mt-3 fa-3x dark:[color:white] hover:[color:#0c4a6e] dark:hover:[color:#02141f]"></i>
            </a>
            <a href="https://github.com/AIAM2601" target="_blank">
              <i className="fa-brands  p-6 fa-github  mt-3 fa-3x dark:[color:white] hover:[color:#0c4a6e] dark:hover:[color:#02141f]"></i>
            </a>
          </div>
        </div>
      </main>
